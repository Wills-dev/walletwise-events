...
import { useGetBredTickets } from "@/lib/hooks/useGetBredTickets";
import Label from "@/components/atoms/Label copy/Label";
import Input from "@/components/atoms/Input copy/Input";

const TickeetForm = () => {
  const { handleChange, userInfo, handleSubmit, isPending } =
    useGetBredTickets();
